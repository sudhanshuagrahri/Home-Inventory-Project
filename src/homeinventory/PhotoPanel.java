...
public class PhotoPanel extends JPanel{
	public void paintComponent(Graphics g)
	{
		...
		if(rWidth>rHeight)
			w=(int)(photoImage.getWidth(null)*rHeight); //leave height at display height, change width by amount height changed
		else
			h=(int)(photoImage.getHeight(null)*rWidth); //leace width at display width , change height by amount width changed
